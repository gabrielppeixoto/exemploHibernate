...
public class AppRevJPA {
	...
	private static void inserAddressByPerson() {
    	...
    	person.setLastName("Mabby");
    	person.setAge(20);
    	person.setDocument(new Document("412.112.152-98", 44161896));
    	person.addPhone(new Phone(TypePhone.RESIDENCIAL, "42211632"));
    	person.addPhone(new Phone(TypePhone.COMERCIAL, "32421411"));
